    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <section class="overflow-hidden mb-5">
            <div class="p-6">
                <div class="flex justify-between mb-4">
                    ...
                    <div class="flex space-x-2 mb-4">
                        <a href="{{ route('matakuliah.create') }}"
                            class="bg-teal-600 text-white px-4 py-2 rounded hover:bg-teal-700">+ Tambah Matakuliah</a>
                    ...
                    <div id="importModal"
                        ...
                        <div class="bg-white rounded shadow-lg p-6 w-full max-w-md">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button id="closeImportModal" class="text-gray-500 hover:text-gray-700">&times;</button>
                            </div>
                ...
                <div class="bg-white shadow-md border rounded-lg p-5 overflow-x-auto">
                    <table id="simpledataTable" class="table-auto w-full pt-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-t px-4 py-2">{{ $mk->dosen->name ?? '-' }}</td>
